...
from busca_heuristica.buscaHeuristica_Contando_Nos import a_estrela, EstadoQuebraCabeca
from busca_cega.IDS_Contando_Nodes import profundidade_timeOut, profundidade, eh_resolvivel, ESTADO_OBJETIVO, ESTADO_INICIAL
